...
$token_purchase_url = $row_api_settings->token_purchase_url;
$token_receive_address = $row_api_settings->token_receive_address;
      ...
      <div class="card mb-5"><!--- card mb-5 Starts --->
        ...
        <div class="card-body"><!--- card-body Starts --->
          <form method="post" enctype="multipart/form-data"><!--- form Starts --->
            ...
            <div class="form-group row"><!--- form-group row Starts --->
            <label class="col-md-3 control-label"> Token Purchase URL : </label>
            <div class="col-md-6">
              <input type="text" name="token_purchase_url" class="form-control" value="<?= $token_purchase_url; ?>">
              <!-- <small class="form-text text-muted">Enable or disable currency converter on the website.</small> -->
            </div>
            </div><!--- form-group row Ends --->

            <div class="form-group row"><!--- form-group row Starts --->
            <label class="col-md-3 control-label"> Token Receive Address : </label>
            <div class="col-md-6">
              <input type="text" name="token_receive_address" class="form-control" value="<?= $token_receive_address; ?>">
              <!-- <small class="form-text text-muted">Enable or disable currency converter on the website.</small> -->
            </div>
            </div><!--- form-group row Ends --->
            ...
            <label class="col-md-3 control-label"></label>
            <div class="col-md-6">
              <input type="submit" name="update_token_settings" class="form-control btn btn-success" value="Update Token">
            </div>
            </div><!--- form-group row Ends --->
...
if(isset($_POST['update_token_settings'])){
    ...
    $update_token_settings = $db->update("api_settings",$data);

    if($update_token_settings){

      echo "<script>alert_success('Token Settings Updated Successfully','index?api_settings');</script>";
