  ...
  <body class="is-responsive">
    ...
    <?php 
      ...
      if(isset($_POST["install"])){
       ...
       // $verify_purchase = 1;//verify_purchase($purchase_code,$site_url);
        ...
        if($verify_purchase->status == "already_used"){
          ...
          if(is_localhost()){
            ...
            $app_license = $db->update("app_license",[
              "purchase_code" => "test", //$verify_purchase->purchase_code,
              "license_type" => "test", //$verify_purchase->license_type,
              "website" => "test", //$verify_purchase->website,
            ]);
          }
