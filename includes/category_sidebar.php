...
<div class="card mb-3">
  <div class="card-header bg-white">
    <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?> h5"><?= $lang['sidebar']['categories']; ?></h3>
  </div>
  <div class="card-body">
      ...
      <li class="nav-item">
        <span class="nav-link 
          <?php
            ...
            ?>">     
        <a href="<?= $site_url; ?>/categories/<?= $cat_url; ?>"> <?= $cat_title; ?></a> 
        <a class="h5 float-right" data-toggle="collapse" data-target="#cat_<?= $cat_id; ?>">
        ...
        <ul id="cat_<?= $cat_id; ?>" class="collapse">
          ...
          ?>
          <li>
            <a class="nav-link <?php if($child_id == @$_SESSION['cat_child_id']){ echo "active"; } ?>" href="<?= $site_url; ?>/categories/<?= $cat_url; ?>/<?= $child_url; ?>">
            <?= $child_title; ?>
            </a>
          </li>
          <?php }} ?>
...
<div class="card mb-3">
  <div class="card-header bg-white">
    <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?> h5"><?= $lang['sidebar']['sort_by']['title']; ?></h3>
  </div>
  <div class="card-body">
...
<div class="card mb-3">
  <div class="card-header bg-white">
    <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?> h5"><?= $lang["sidebar"]["seller_country"]; ?></h3>
...
<div class="card mb-3 seller-cities d-none">
  <div class="card-header bg-white">
...
<div class="card mb-3">
  <div class="card-header bg-white">
    <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?> h5"><?= $lang['sidebar']['delivery_time']; ?></h3>
...
<div class="card mb-3">
  <div class="card-header bg-white">
    <h3 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?> h5"><?= $lang['sidebar']['seller_level']; ?></h3>
...
<div class="card mb-3">
  <div class="card-header bg-white">
    <h2 class="float-left h5"><?= $lang['sidebar']['seller_lang']; ?></h2>
